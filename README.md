...
🔭 Currently building a multi-agent RAG pipeline (Transformer Architecture & Training Strategy research) as part of an AI Agents internship, and enrolled in DEPI's Data Science & AI Track (Round 5)
